                       ...
                       children: [
                          ...
                          children: [
                            Padding(
                              ...
                              child: Image(
                                height: 25,
                                width: 25,
                                image: AssetImage("assets/icons/bussiness.png")),
                            ),
                              SizedBox(width: 15,),
                         ...
                         InkWell(
                          onTap: (){
                           ...
                           child: Row(
                              children: [
                                Image(image: AssetImage("assets/icons/ios_arrow.png")),
                              ],
                            ),
                         ),
                       ],
                       ...
                       children: [
                         ...
                         InkWell(
                          onTap: (){
                            Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) =>  ManageQrPosView()),
                                );
                          },
                           child: Row(
                              children: [
                         ...
                         Row(
                            children: [
                              InkWell(
                                ...
                                child: Image(image: AssetImage("assets/icons/ios_arrow.png"))),
                            ],
                          ),
                       ],
                     ),
