...
class OtpVerifySignUpView extends StatefulWidget {
  const OtpVerifySignUpView({super.key});

  @override
  State<OtpVerifySignUpView> createState() => _OtpVerifySignUpViewState();
}

class _OtpVerifySignUpViewState extends State<OtpVerifySignUpView> {
  bool isEnabled = true;
  @override
